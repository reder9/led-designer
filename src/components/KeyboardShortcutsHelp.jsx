  ...
  if (!isVisible) {
    return (
      ...
      >
        ...
        <svg className="w-4 h-4 relative z-10 group-hover:rotate-6 transition-transform duration-300" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {shortcuts.map((category, categoryIndex) => (
              <div key={categoryIndex} className="bg-gray-900 rounded-xl p-4 border border-gray-700">
