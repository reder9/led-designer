  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        ...
        >
          <span
            className={`font-bold ${selectedText.fontWeight === 'bold' ? 'text-white' : 'text-gray-300'}`}
          >
            B
          </span>
        </button>
        ...
        >
          <span
            className={`italic ${selectedText.fontStyle === 'italic' ? 'text-white' : 'text-gray-300'}`}
          >
            I
          </span>
        </button>
        ...
        <div className='flex gap-1'>
          {['left', 'center', 'right'].map(alignment => (
            <button
              ...
              className={`flex-1 px-2 py-1 rounded ${
                selectedText.textAlign === alignment
                  ? 'bg-cyan-600'
