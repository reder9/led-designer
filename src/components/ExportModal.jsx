    ...
    <div className='fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm'>
      <div className='bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-600 rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4'>
        ...
        <div className='text-center mb-6'>
          ...
          <p className='text-gray-400 text-sm'>Preparing your LED panel for export...</p>
        </div>
        ...
        <div className='absolute inset-0 rounded-2xl overflow-hidden pointer-events-none'>
          ...
          <div
            className='absolute -bottom-32 -right-32 w-64 h-64 bg-blue-500/10 rounded-full animate-pulse'
